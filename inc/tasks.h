...
#define EV_GAME_OVER_TS			(uint16_t)(0x0002)

//Event flags for Reset Game
//#define EV_GAME_OVER (uint16_t)(0x0001)
//#define EV_RESTART_GAME (uint16_t)(0x0002)
